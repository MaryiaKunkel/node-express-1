...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2024-03-08T16:40:33.087231" />
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/pigsty-battery-included-postgresql-distro-free-rds-alternative-v26-released-2816/">Pigsty, Battery-included PostgreSQL Distro &amp; Free RDS Alternative, v2.6 released!</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-03-06 by Pigsty</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pg_ivm-18-released-2818/">pg_ivm 1.8 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-03-04 by IVM Development Group</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgbouncer-1221-released-2819/">PgBouncer 1.22.1 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-03-04 by PgBouncer</li>
              </ul>
            </li>
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6pt"> Speed up PostgreSQL pgvector queries with indexes</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;oded valin</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-03-08</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6pr"> Announcing Tembo CLI: Infrastructure as code for the Postgres ecosystem</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6ps"> CloudNativePG Recipe 2 - Inspecting Default Resources in a CloudNativePG Cluster</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6po"> Recovery Hack: Restoring Tablespace Using Barman on Windows</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;semab tariq</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-03-07</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6pp"> Rails + Postgres Postgres.FM 086 — Extended blog post edition! 🎙️</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6pn"> Setting up a debugging environment in PostgreSQL to better understand OpenSSL APIs</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;David Z</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-03-06</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6pm"> PGSQL Phriday #016</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6pl"> Exploring JSONB in PostgreSQL</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Goutham Reddy Banala</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-03-06</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6pq"> Connecting QGIS to Postgres and PostGIS</a></h3>
            <ul class="meta">
